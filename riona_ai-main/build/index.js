...
async function handleError(error, schema, prompt, runAgent) {
    if (error instanceof Error) {
        if (error.message.includes("503 Service Unavailable")) {
            ...
            logger_1.default.error("Rate limit reached. Waiting before retry...");
...
async function main() {
    try {
        ...
        logger_1.default.error('Error running application:', error);
        process.exit(1);
    }
}
main();
